...
import { initGatewayClient } from "./gateway-client";

// Initialize Gateway WebSocket client for NL Command
initGatewayClient();
...
// Disable caching on all API routes so mobile browsers always get fresh data
...
(async () => {
  ...
  if (runStartupMigrations) {
    ...
    console.log('[Startup] DB migrations skipped; set RUN_STARTUP_MIGRATIONS=true to run them');
  }
